...
/*
 ...
 Denna vykontroller styr en tabell som visar l.-änkar. När en användare trycker på en länk pushas DetailViewController
...
- (void)dataSource:(MDMFetchedResultsTableDataSource *)dataSource configureCell:(id)cell withObject:(id)object {
    ...
    aCell.textLabel.text = link.title.description;
    aCell.detailTextLabel.text = link.url.description;
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    //ändrar initWithKey till title och ascending till YES
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"title" ascending:YES];
    NSArray *sortDescriptors = @[sortDescriptor];
    
    [fetchRequest setSortDescriptors:sortDescriptors];
    
    NSFetchedResultsController *anotherFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"Master"];
    anotherFetchedResultsController.delegate = self;
    self.fetchedResultsController = anotherFetchedResultsController;
